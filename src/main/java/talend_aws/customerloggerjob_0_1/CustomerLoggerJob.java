...
package talend_aws.customerloggerjob_0_1;
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String projectName = "TALEND_AWS";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_wMxNMFyhEfC9K_vmo82oyQ", "0.1");
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_TALEND_AWS_CustomerLoggerJob = new byte[0];
    static byte[] commonByteArray_TALEND_AWS_CustomerLoggerJob = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TALEND_AWS_CustomerLoggerJob.length) {
				if(length < 1024 && commonByteArray_TALEND_AWS_CustomerLoggerJob.length == 0) {
   					commonByteArray_TALEND_AWS_CustomerLoggerJob = new byte[1024];
				} else {
   					commonByteArray_TALEND_AWS_CustomerLoggerJob = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TALEND_AWS_CustomerLoggerJob, 0, length);
			strReturn = new String(commonByteArray_TALEND_AWS_CustomerLoggerJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TALEND_AWS_CustomerLoggerJob, 0, length);
			strReturn = new String(commonByteArray_TALEND_AWS_CustomerLoggerJob, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TALEND_AWS_CustomerLoggerJob) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_1", "oNHKE8_");
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"id","name","email",});        
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"C:/Users/HP/Downloads/customers (7).csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "C:/Users/HP/Downloads/customers (7).csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("C:/Users/HP/Downloads/customers (7).csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_1");
                ...
                if(!((Object)("C:/Users/HP/Downloads/customers (7).csv") instanceof java.io.InputStream)){
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'CustomerLoggerJob' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_wMxNMFyhEfC9K_vmo82oyQ");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-09T09:00:07.572719Z");
        ...
        try {
            ...
            java.io.InputStream inContext = CustomerLoggerJob.class.getClassLoader().getResourceAsStream("talend_aws/customerloggerjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     80289 characters generated by Talend Cloud Data Management Platform 
 *     on the 9 July 2025 at 2:30:07 pm IST
 ************************************************************************************************/